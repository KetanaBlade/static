  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 p-4 sm:p-5 rounded-2xl border border-border bg-card shadow-xs">
      ...
      <div className="flex flex-wrap items-center gap-2.5">
        <span className="text-xs sm:text-sm font-bold text-foreground flex items-center gap-2 shrink-0">
        ...
        <div className="flex items-center gap-2 flex-1 sm:flex-none">
          <select
            ...
            className="h-10 px-3.5 rounded-lg border border-border bg-background text-xs sm:text-sm font-bold text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 shadow-xs cursor-pointer truncate max-w-[280px]"
          >
          ...
          <button
            ...
            className="h-10 px-3 rounded-lg border border-border bg-background hover:bg-muted text-muted-foreground hover:text-foreground text-xs sm:text-sm font-bold flex items-center gap-1.5 transition-colors shadow-xs cursor-pointer"
          >
      ...
      <div className="flex flex-wrap items-center gap-3.5 pt-2 lg:pt-0 border-t lg:border-t-0 border-border/60">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="h-9 px-3 rounded-lg border border-border bg-background text-xs sm:text-sm font-bold text-foreground focus:outline-none focus:ring-1 focus:ring-primary shadow-xs cursor-pointer"
          >
